...
foreach ($files as $file) {
    ...
    match (true) {
        str_contains($file, determineSeparator('src/SkeletonTool.php')) => rename($file, determineSeparator('./src/'.$className.'Tool.php')),
        str_contains($file, determineSeparator('src/SkeletonToolkit.php')) => rename($file, determineSeparator('./src/'.$className.'Toolkit.php')),
